...
const Card : FC<Props> = ({place}) => {
    return (
     <Link to={`/place/${place.id}` } className='border border-zinc-300 
     rounded-md p-4 gap-4 grid grid-cols-3 min-h-[300px] hover:shadow-md '>
...
<span className='text-xs text-gray-400'>Vergiler ve ücretler dahil</span>
</div>
